<template>
  <div class="flex-col justify-center items-center w-3/5 h-full rounded-xl shadow-lg pt-4 pb-4 bg-white bg-opacity-90 backdrop:blur-sm">
    <div class="w-full h-full p-10">
      <div class="flex flex-col justify-center items-center">
        ...
        <button type="button" @click="register"
          class="rounded-xl w-3/5 h-10 text-white bg-indigo-500/90 text-md transition-all ease-in-out hover:bg-indigo-600 focus:ring-2 font-semibold
...
// 引入 reactive 并创建 registerData  reactive 对象
...
async function getCaptcha() {
  ...
  // 根据邮箱获取验证码 localhost:8080/register/sendVerificationCode?userEmail=1164659757@qq.com
