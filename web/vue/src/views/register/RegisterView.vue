<template>
  <div class="min-h-screen w-full bg-gradient-to-br from-indigo-500/10 to-purple-500/10 flex flex-col">
    <!-- 顶部导航栏 -->
    ...
    <div class="container mx-auto px-8 py-12 flex-grow flex flex-col">
      <div class="max-w-6xl mx-auto w-full flex flex-col lg:flex-row gap-8 justify-center">
        <!-- 左侧注册表单 -->
...
import RegisterLeftComponent from '@/components/RegisterLeftComponent.vue';
import RegisterRightComponent from '@/components/RegisterRightComponent.vue';
</script>
